...
def train(args, debug = False):
    ...
    if not debug:
        ...
        wandb.run.name = f"{args.label}_{args.model}{dropout_str}-lr:{args.lr}-wd:{args.weight_decay}_" + wandb.run.name
    ...
    nih_train_data = NIH(args.root, nih_pathFileTrain,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_storage', type=str, default="/data/mariammaa/nih_multi_label/checkpoints/", help='model folder to save the model')
